...
| 29B.4 | EU/UK regulated-disclosure connectors (umbrella) | 🟡 | — | tbd | umbrella: 4A UK FCA NSM ✅ (#58 `5138725`); 4B Euronext 🟡 in progress (branch `feature/phase-29b4b-euronext-disclosures` @ `cd6b02a`, PR pending); 4C Swiss/Nordic/Germany upcoming |
