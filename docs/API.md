...
```json
{
  ...
  "summary": { "enabled": 11, "configured": 3, "scaffolded": 2, "planned": 19, "disabled": 0, "total": 32 },
...
multilingual and major issuers publish English). **Scaffolded** filing/regulator
...
gap (T1 filing content not fetched at report time).
