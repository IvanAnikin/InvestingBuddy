...
```json
{
  ...
  "summary": { "enabled": 26, "configured": 3, "scaffolded": 2, "planned": 7, "disabled": 0, "total": 35 },
...
government sources reuse `trade_policy` / `macro_statistics`).
...
surfaced as source gaps): USAspending, EU TED, OpenBB, Google Patents, USPTO,
EPO Espacenet, local-language business press.
...
+ government **PR open / pre-staging** at `2318a9b`). Fifteen official public
