...
def test_8_registry_promotes_three_connectors_to_enabled():
    ...
    # Registry now reports 31 enabled / 2 scaffolded sources (Phase 29C.1 added
    ...
    # 29D.1 added 2 reference-only procurement / tender event sources, and 29D.2
    # added 3 reference-only patent office / index event sources to the 11
    # regulator-layer enabled sources).
    summary = reg.summary()
