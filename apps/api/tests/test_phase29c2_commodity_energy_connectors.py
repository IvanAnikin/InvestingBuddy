...
``MacroReferenceConnector`` used in Phase 29C.1. Covers:
  ...
  * The sources are registered + enabled in the registry with honest reliability
    notes; the registry summary is 21 enabled / 2 scaffolded / 9 planned and the
    commodity / energy ids are no longer planned; everything stays secret-free.
