...
# Preflight identity-resolution failures (Slice 5B.1 hotfix) — a real candidate
# was known but never reached a network fetch.
FAILURE_MISSING_CIK = _vocab.FAILURE_MISSING_CIK
FAILURE_CONFLICTING_CIK = _vocab.FAILURE_CONFLICTING_CIK
FAILURE_MALFORMED_ACCESSION = _vocab.FAILURE_MALFORMED_ACCESSION
FAILURE_INVALID_SEC_URL = _vocab.FAILURE_INVALID_SEC_URL
FAILURE_NO_PRIMARY_FILING_DOCUMENT = _vocab.FAILURE_NO_PRIMARY_FILING_DOCUMENT
FAILURE_PREFLIGHT_BUDGET_EXHAUSTED = _vocab.FAILURE_PREFLIGHT_BUDGET_EXHAUSTED
