...
const REPORT_MARKDOWN = [
  ...
  "- **Press-release feed:** https://www.example.com/newsroom/rss/newsroom-current-quarterly-press-releases-feed.rss",
  ...
  "| press_release_feed | T1_primary_filing | curated_verified_registry | 0.95 | [source](https://www.example.com/newsroom/rss/newsroom-current-quarterly-press-releases-feed.rss) |",
  "",
  "## SEC Filing Events",
  "",
